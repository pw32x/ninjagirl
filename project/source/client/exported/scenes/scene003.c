...
const CreateInfo scene003_createInfo7 = { &colortweaker_template, 23, 36 };
const CreateInfo scene003_createInfo8 = { &test_block_template, 164, 30 };
const CreateInfo scene003_createInfo9 = { &test_block_template, 248, 48 };
const CreateInfo scene003_createInfo10 = { &test_block_template, 256, 96 };
const CreateInfo scene003_createInfo11 = { &test_block_template, 432, 144 };
const CreateInfo scene003_createInfo12 = { &test_block_template, 432, 96 };
const CreateInfo scene003_createInfo13 = { &test_block_template, 567, 64 };
const CreateInfo scene003_createInfo14 = { &test_block_template, 624, 128 };
...
const Command scene003_commands[] = 
{
    ...
    { 23, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo7 },
    { 172, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo8 },
    { 256, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo9 },
    { 264, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo10 },
    { 440, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo11 },
    { 440, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo12 },
    { 575, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo13 },
    { 632, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &scene003_createInfo14 },
