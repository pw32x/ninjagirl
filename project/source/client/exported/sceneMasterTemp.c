...
const CreateInfo sceneMasterTemp_createInfo6 = { &robotrunner_template, 112, 80 };
const CreateInfo sceneMasterTemp_createInfo7 = { &robotrunner_template, 166, 129 };
const CreateInfo sceneMasterTemp_createInfo8 = { &walker_template, 248, 58 };
const CreateInfo sceneMasterTemp_createInfo9 = { &walker_template, 324, 55 };
const CreateInfo sceneMasterTemp_createInfo10 = { &robotrunner_template, 336, 128 };
const CreateInfo sceneMasterTemp_createInfo11 = { &walker_big_template, 458, 96 };
const CreateInfo sceneMasterTemp_createInfo12 = { &robotrunner_template, 612, 65 };
...
const Command sceneMasterTemp_commands[] = 
{
    ...
    { 30, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo5 },
    { 121, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo6 },
    { 175, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo7 },
    { 256, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo8 },
    { 332, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo9 },
    { 345, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo10 },
    { 474, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo11 },
    { 621, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &sceneMasterTemp_createInfo12 },
