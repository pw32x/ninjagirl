<Scene>
  ...
  <EditorObjects>
    ...
    <GameObject Name="Robot Runner" X="64.53469364426155" Y="128.16275505829904" GameObjectTemplateName="Robot Runner" />
    <GameObject Name="Robot Runner" X="368.6530635573883" Y="64.55611997027898" GameObjectTemplateName="Robot Runner" />
    <GameObject Name="Walker (Big)" X="448.139796239141" Y="96.46581718678553" GameObjectTemplateName="Walker (Big)" />
    <GameObject Name="Walker" X="240" Y="144.05051511774107" GameObjectTemplateName="Walker" />
    <GameObject Name="Walker" X="352.0015324931449" Y="32.766835991083695" GameObjectTemplateName="Walker" />
    <GameObject Name="Robot Runner" X="608.0933677697751" Y="80.53622613740279" GameObjectTemplateName="Robot Runner" />
    <GameObject Name="Robot Runner" X="127.01838634545177" Y="96.5475787322816" GameObjectTemplateName="Robot Runner" />
    <Command Name="Set Background Vertical Scroll" X="-159" Y="-70" CommandValue="4" PreCommandData="" />
    <GameObject Name="Color Tweaker" X="88" Y="7" GameObjectTemplateName="Color Tweaker" />
  </EditorObjects>
</Scene>