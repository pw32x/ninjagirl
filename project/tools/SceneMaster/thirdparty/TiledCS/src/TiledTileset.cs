    ...
    public class TiledTileset
    {
        ...
        public void ParseXml(string xml)
        {
            try
            {
                ...
                var columns = nodeTileset.Attributes["columns"];
                var tiledVersion = nodeTileset.Attributes["tiledversion"];
                ...
                if (tiledVersion != null) TiledVersion = tiledVersion.Value;
                if (columns != null) Columns = int.Parse(nodeTileset.Attributes["columns"].Value);
